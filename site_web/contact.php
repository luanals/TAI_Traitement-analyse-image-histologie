...
if (isset($_POST['submit'])) {
    ...
    if (!$email) {
        $message_status = "⚠️ L'adresse email fournie n'est pas valide.";
    } elseif (empty($name) || empty($subject) || empty($message)) {
        $message_status = "⚠️ Veuillez remplir tous les champs du formulaire.";
    } else {
        ...
        if (mail($to, $subject, $email_content, $email_headers)) {
            ...
            $message_status = "⚠️ Erreur critique lors de l'envoi. Veuillez vérifier la configuration de mail() sur le serveur.";
        }
    }
}
?>
